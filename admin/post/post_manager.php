...
<body>
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <?php
            $res = mysqli_query($conn, "SELECT id, PostTitle, PostingDate, Is_Active, PostUrl FROM tblposts WHERE 1");
            ?>
            <?php 
            if ($res->num_rows > 0) {
                while ($row = $res->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        &nbsp;<a href="view_post.php?pid=<?php echo htmlentities($row['id']); ?>&&action=del" onclick="return confirm('Do you reaaly want to delete ?')"> <i class="fa fa-trash-o" style="color: #f05050"></i></a> </td>
                    </tr>
                <?php }
            }?>
