<script src="./admin/include/vendor/jquery/jquery.min.js"></script>
<script src="./admin/include/vendor/bootstrap/js/bootstrap.js"></script>
<script src="./admin/include/vendor/jquery-easing/jquery.easing.min.js"></script>
...
<script src="https://previews.envatousercontent.com/files/248335856/src/js/breaking-news-ticker.min.js"></script>
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v7.0"></script>
<script src="./admin/assets/js/dashbordCont.js"></script>
